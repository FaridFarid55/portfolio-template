export const DATA = {
  home: {
    hero: {
      ...
      subtitle:
        "I build fast, reliable, and well-structured web experiences.",
    },
skills: {
  sectionTitle: "Skills & Expertise",
  sectionDescription:
    "Focused on building efficient, scalable, and user-centric web applications with modern technologies",
  overview: [
    {
...
testimonials: {
  ...
  sectionDescription: "What clients say about working with me",
  items: [
    {
      id: 1,
      name: "Ahmed Khaled",
      role: "Founder at ElectronicsFix",
      content:
        "Farid developed our full admin panel with an elegant interface and powerful backend. His clean code and attention to detail made managing products and users effortless.",
      avatar: "https://img.heroui.chat/image/avatar?w=100&h=100&u=1",
    },
    {
      id: 2,
      name: "Mona Hassan",
      role: "Project Manager at TechVision",
      content:
        "Working with Farid was a great experience. He delivered a fast and secure web solution ahead of schedule. His problem-solving skills are outstanding.",
    ...
    },
    {
      ...
      role: "CTO at LapShop",
      content:
        "Farid built a robust e-commerce platform for our team, integrating advanced admin controls and smooth user experience. His ability to handle both front and back end was impressive.",
    ...
    },
    {
      ...
      content:
        "Collaborating with Farid was smooth and inspiring. He transformed my UI designs into fully functional, responsive, and fast-loading web pages with perfect precision.",
    ...
    },
    {
      ...
      content:
        "Farid turned our startup idea into a live web app with complete user management, real-time features, and an intuitive dashboard. His communication and commitment were top-notch.",
  ...
  about: {
    profile: {
      ...
      image:
        "https://res.cloudinary.com/dvau0y0h0/image/upload/v1764881326/Farid-Logo_j0bgdj.png",
      description: [
                      "I'm a passionate full-stack developer who loves crafting powerful and scalable web applications with clean, efficient code. I focus on building high-performance, secure, and user-friendly digital experiences.",
...
,
  ...
  projects: {
    ...
    sectionDescription:
      "A selection of my recent projects showcasing full-stack development and problem-solving expertise.",
    work: [
      {
        id: 1,
  ...
  footer: {
    ...
    contact: {
      email: "faridfaridfr5@gmail.com",
      phone: "+20 1009266353 | +20 1552460600",
      location: "Egypt, Kafr-Elsheikh",
    },
    socialLinks: [
      { platform: "X", url: "https://x.com", icon: "simple-icons:x" },
      { platform: "GitHub", url: "https://github.com/FaridFarid55", icon: "mdi:github" },
      {
        platform: "LinkedIn",
        url: "https://linkedin.com/in/farid-farid-123456789",
        icon: "mdi:linkedin",
      },
      {
       platform: "Discord",
